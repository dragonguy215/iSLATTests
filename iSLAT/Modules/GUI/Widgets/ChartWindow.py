...
class MoleculeSelector:
    def __init__(self, master, data_field, user_settings=None, islat=None):
        ...
        self.isotopologue_data = {
            ...
            "NO2": [("14N16O2", 1), ("15N16O2", 2), ("14N16O18O", 3)],
            "NH3": [("14NH3", 1), ("15NH3", 2)],
            ...
            "HCOOH": [("H12C16O16OH", 1), ("H13C16O16OH", 2)],
            "HO2": [("H16O2", 1)],
            "O": [("16O", 1)],
            ...
            "CH3": [("12CH3", 1)],
            "S2": [("32S2", 1)],
            "COFCl": [("12C16O19F35Cl", 1), ("12C16O19F37Cl", 2)],
            "HONO": [("H16O14N16O", 1)],
            "ClNO2": [("35Cl14N16O2", 1), ("37Cl14N16O2", 2)],
        }
